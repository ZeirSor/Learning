/****************************************************************************
** Meta object code from reading C++ file 'dialog_gaussblur.h'
**
...
#include "../../qtimage-main/dialog/dialog_gaussblur.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'dialog_gaussblur.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 20) // "on_buttonOK_accepted"

    },
    "GaussianBlurDialog\0sendData\0\0"
    "on_buttonOK_accepted"
};
...
void GaussianBlurDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_buttonOK_accepted(); break;
        default: ;
        }
        ...
        {
            typedef void (GaussianBlurDialog::*_t)(int , double );
...
const QMetaObject GaussianBlurDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GaussianBlurDialog.data,
      qt_meta_data_GaussianBlurDialog,  qt_static_metacall, nullptr, nullptr}
};
